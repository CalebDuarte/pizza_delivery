...
//process steps with timing (in seconds)
const processSteps = [
...
function startDeliveryProcess(){
    ...
    addUpdate(
        "Order Recived",
        "Your order has been recived and is being processed.",
    );
...
function startPreparation(){
    ...
    //log the setTimeout usage for the first trasnsition
    addUpdate(
        "Timer Method",
...
function getStatusMessage(stepIndex){
    const messages = [
        "We've recived your order and it's been sent to the kitchen.",
        "Our chefs are preparing your pizza with fresh ingredients.",
        "Your pizza is now baking in our brick oven at 700º F.",
        "We're checking that your pizza meets our quality standards.",
        "Your pizza is on it's way! Our delivery person is en route.",
...
function addUpdate(title, message){
    ...
    updateItem.className = 'update-time';
